...
(function ($) {
	$.cookieBubble = function (options) {
			...
			var settings = $.extend({	
				cookieMaxAge  							: 30, 
				messageText								: 'We respect your privacy and only use cookies to remember your high score.', 
				...
				iconColor								: '#733509',    			 
				iconVisibility		  					: true, 		              
				cookiePolicyButtonText					: 'What are cookies?',
				cookiePolicyButtonTextColor		    	: '#000',
